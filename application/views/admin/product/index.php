								...
								<select name="catalog">
									...
									<?php if(count($row->subs) > 0): ?>
										...
										<?php foreach($row->subs as $value): ?>
											<option value="<?php echo $value->id; ?>" <?php echo ($value->id == $this->input->get('catalog')) ? 'selected' : '' ?> >
												<?php echo $value->name; ?>
											</option>
										<?php endforeach; ?>
										</optgroup>
			...
			<tr>
				<td colspan="6">
					<div class="list_action itemActions">
						<a url="<?php echo admin_url('product/delete_all'); ?>" id="submit" class="button blueB">
			...
			<tbody class="list_item">
				...
				<tr class="row_<?php echo $row->id; ?>" >
					...
					<td class="textR">
						...
						<b style="color:red"><?php echo $price_new ?></b>
