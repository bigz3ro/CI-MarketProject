					...
					<div id="tab1" class="tab_content pd0">
						...
						<div id="tab1" class="tab_content pd0">
							...
							<div class="formRow">
								...
								<div class="formRight">
									<span class="oneTwo"><input value="<?php echo $info->username ?>" name="username" id="param_username" _autocheck="true" type="text"></span>
							...
							<div class="formRow">
								...
								<div class="formRight">
									<span class="oneTwo">
										...
										<p style="color: red">Nếu thay đổi mật khẩu mới nhập giá trị</p>
									</span>
